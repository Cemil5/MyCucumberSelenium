...
public static void finalTriple (String str) { // metinde ardýþýk olarak ayný harften 3 tane var mý diye kontrol eder
	...
	public static void firstThreeLetter(String str) { // metinde geçen bütün harfleri kontrol eder 3 veya fazla varsa tripple olarak sayar
