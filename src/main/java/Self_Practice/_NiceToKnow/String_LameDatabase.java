...
public class String_LameDatabase {

	public static void main(String[] args) {

	System.out.println(lameDb("1etsy#2wooden#3spoon","add","4","aaa").equals("1etsy#2wooden#3spoon#4aaa")); // örnek olarak verilen test case'leri geçiyor mu diye kontrol etmek için
